  ...
  <body>
   <header>
    ...
    <div class="therapy-banner container">
          <div class="row">
              <div class="col-md-6">
                  <img src="./images/EDTA-CALCIUM-PUSH-drip.jpg" class="img-fluid">
              </div>  
              <div class="col-md-6">
                  <h4>EDTA Calcium “push”</h4>
                  <h5>IV TREATMENT</h5>
                  <h6>Lorem ipsum dolor sit amet</h6>
                  <p>Chelation therapy is treatment used in conventional medicine for removing heavy metals (including mercury) from the blood. It involves intravenous injections of a chelating agent, EDTA , a synthetic amino acid. EDTA binds to heavy metals and minerals in the blood so that they can be excreted in the urine.</p>
   ...
   <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">                
                    <img src="./images/EDTA-CALCIUM-PUSH.jpg" class="img-fluid d-block mx-auto">
