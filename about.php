...
<html lang="en">
  ...
  <body>
   <header>
    ...
    <div class="banner container">
        ...
        <div class="about-inner-text">
            ...
            <a href="index.html#book-now">BOOK NOW</a>
        </div>  
    </div>  <!-- banner-end -->
    
 
    <div id="about">
      <div class="complimentary-consultation">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h3>Our processes are designed to give you the best IV therapy experience</h3>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore.</p>   
                </div>  
                <div class="col-md-5">
                  <div class="bg">
                    <h2>Book a complimentary consultation</h2> 
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#schedule-appointment">SCHEDULE NOW</a>
                  </div>  
                </div>  
            </div>  
        </div> <!-- container end --> 
      </div> <!-- complimentary consultation -->  

        <div class="container our-team">
          <div class="row">
              <div class="col-md-4">
                <img src="./images/our-team.png" class="img-fluid">
   ...
   <!-- Modal -->
<div class="modal fade" id="schedule-appointment" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
