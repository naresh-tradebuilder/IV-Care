...
<html lang="en">
  ...
  <header>
    ...
    <div class="therapy-banner container">
          <div class="row">
              <div class="col-md-6">
                  <img src="./images/ALPHA-LIPOIC-ACID-drip.jpg" class="img-fluid">
              </div>  
              <div class="col-md-6">
                  <h4>Alpha lipoic acid</h4>
                  <h5>IV TREATMENT</h5>
                  <h6>Lorem ipsum dolor sit amet</h6>
                  <p>Detoxification of heavy metals, anti-oxidant, kidney health, nerve health, controls blood sugar naturally, liver health, protects the body from radiation damage. </p>
   ...
   <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">                
                    <img src="./images/ALPHA-LIPOIC-ACID.jpg" class="img-fluid d-block mx-auto">
